...
class WebViewExample extends StatelessWidget {
  final baseUrl = "https://goldenrabbit.co.kr/product/must-have-codefactory-flutter";
    ...
    var controller = WebViewController()
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (String url) { print("load finished ${url}"); },
    ...
    return (MaterialApp(
      ...
      home: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                onPressed: () { controller.loadRequest(Uri.parse(baseUrl)); },
